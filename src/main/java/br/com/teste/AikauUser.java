...
/**
 * <p>This is to all intents and purposes the same as the br.com.teste.web.site.SlingshotUser class that is used by the
...
public class AikauUser extends AlfrescoUser
{
    ...
    /**
     * @see br.com.teste.connector.User#save()
     */
    @Override
    public void save()
    {
