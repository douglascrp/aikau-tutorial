...
import br.com.teste.AikauLoginController;
...
/**
 * <p>This is to all intents and purposes the same as the br.com.teste.web.site.SlingshotUserFactory class that is used by the
...
public class AikauUserFactory extends AlfrescoUserFactory
{
    ...
    /**
     * @see br.com.teste.web.site.UserFactory#authenticate(br.com.teste.web.site.RequestContext, javax.servlet.http.HttpServletRequest, java.lang.String, java.lang.String)
     */
    @Override
